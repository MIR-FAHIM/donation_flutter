                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: RadioListTile(
                                title: Text("MFS", style: TextStyle(fontSize: 12),),
                                value: 1,
                            ...
                            SizedBox(
                              width: _size.width*.32,
                              child: RadioListTile(
                                title: Text("Bank",style: TextStyle(fontSize: 12),),
                                value: 3,
                                contentPadding:EdgeInsets.fromLTRB(0, 0, 0, 0),
                                groupValue: controller.grpValue.value,
                                onChanged: (value){
                      ...
                      BlockButtonWidget(
                        onPressed: () {
                            ...
                            if(controller.amount.value.isEmpty) {
                              Get.showSnackbar(Ui.ErrorSnackBar(message: "Please give an amount", title: 'error'.tr));

                            } else {
                              controller.paymentMethodId.value = controller.grpValue.value.toString();
                             if(controller.grpValue.value == 3){
                               controller.getPaymentTypeController(controller.grpValue.value).then((e){
                                 if(controller.grpValue.value == 3){
