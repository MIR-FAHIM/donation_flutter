...
class ProcedureView extends GetView<HomeController> {
  @override
                ...
                InkWell(
                  onTap: () {
                    ...
                    controller.getBankList(
                        controller.projectData.value.id.toString());
                  },
                  child: ConstrainedBox(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                              color: const Color(0xFF652981).withOpacity(0.4),
                              blurRadius: 6,
                              spreadRadius: 1,
                        ...
                        steps: <Step>[
                          ...
                          const Step(
                            title: Padding(
                              padding: EdgeInsets.fromLTRB(10, 0, 5, 2),
                              child: Text(
                                "Donate amount manually then fill up transaction details. Project authority will get this transaction and will verify your donation.",
                                style: TextStyle(
                          ...
                          const Step(
                            title: Padding(
                              padding: EdgeInsets.fromLTRB(10, 0, 5, 2),
                              child: Text(
                                "After verified your donation , your donation amount will be updated and you can check your transaction from profile.",
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.normal),
                              ),
