...
class UserType extends GetView<OfferController> {
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Payer", style: TextStyle(color: Colors.white),)),
                        ),
                      ),
                      SizedBox(height: 20,),
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Collector", style: TextStyle(color: Colors.white),)),
                        ),
                      ),
                    ],
                  ),
