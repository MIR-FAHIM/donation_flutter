...
class StatementWidgetDetails extends GetWidget<AccountStatementController> {
            ...
            return SingleChildScrollView(
              child: Column(
                children: List.generate(
                    controller.accountStatement.value.data!.where((element) => element.transaction_name == Get.arguments[0]).length, (index) {
                      var data = controller.accountStatement.value.data!.where((element) => element.transaction_name == Get.arguments[0]).toList()[index];
