...
import 'package:latest_payplus_agent/app/modules/buy_product/views/buy_payment_details_before_pay_view.dart';
                        ...
                        onTap: () {
                          if (paymentMethod[index].title == 'Hand Cash' &&
                            ...
                            Get.showSnackbar(Ui.ErrorSnackBar(
                                message: 'Please select a vendor'.tr, title: 'Error'.tr));
                          }
                        },
                        child: Container(
                          width: _size.width,
