...
class AllDonationList extends GetView<AdminController> {
          ...
          return Scaffold(
            ...
            body: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: controller.allDonationList.value.where((element) => controller.selectedProjectId.value == element.projectId).toList().length,

                itemBuilder: (BuildContext context, index) {
                  var data = controller.allDonationList.value.where((element) => controller.selectedProjectId.value == element.projectId).toList()[index];
                  return Padding(
