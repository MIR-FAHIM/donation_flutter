...
import '../../../../../common/color_constant_custom.dart';

class AddDonationTabBar extends GetView<AdminController> {
            ...
            child: DefaultTabController(
              ...
              child: Column(
                children: [
                  ...
                  ).box.height(50).color(tabBgColor).roundedSM.width(340).make(),
                  const SizedBox(height: 15),
                  SizedBox(
                    height: Get.height * .9,
                    child: TabBarView(
                      children: controller.tabScreenList, //tabscreen list
                    ),
                  ),
                ],
              ),
