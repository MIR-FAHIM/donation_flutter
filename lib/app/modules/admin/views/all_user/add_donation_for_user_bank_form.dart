...
class AddDonationForUser extends GetView<AdminController> {
      ...
      body: SingleChildScrollView(
        child: Obx(() {
          return Padding(
            ...
            child: Form(
              key: controller.donationFormKey.value,
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          controller: controller.refferanceController.value,
                          keyboardType: TextInputType.text,
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                  ...
                  BlockButtonWidget(
                    onPressed: () {
                      controller.changeDonationAmountForUser(


                           account_name: controller.accountNameController.value.text,
                           account_num: controller.accountNumController.value.text,

                           ref: controller.refferanceController.value.text,
                           bankName: controller.bankNameController.value.text,
